describe Extensions::Faker::Money do
  
  let(:money_faker) { Extensions::Faker::Money }
  ...
  describe "#within" do
    ...
    shared_examples_for "a within invocation returning values within an expected range" do
      ...
      let(:result) { money_faker.within(starting_price, ending_price) }
