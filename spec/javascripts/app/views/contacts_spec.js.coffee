define(["app/views/contacts", "app/models/contact"], (ContactsView, Contact) ->
    ...
    describe("when instantiated", () ->
      ...
      describe("#update", () ->
        ...
        assertContact = (container, expectedValues) ->
          ...
          expect(jqueryContainer.find(".balance")).toHaveText(new RegExp(regex_escape(expectedValues.balance)))
      )
